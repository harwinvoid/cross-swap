...
import { Erc20, ArgentWalletDetector, EnsPublicResolver, EnsRegistrar, Weth, Erc721 } from '../abis/types'
...
export function useNFTContrct(tokenAddress?: string, withSignerIfPossible?: boolean) {
